	  ...
	  <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="form-horizontal col-md-12" role="form">
                ...
                <%--Tipo--%>
                <div class="form-group">
                    <label for="TipoDropDownList" class="col-md-3 control-label input-sm">User</label>
                    <div class="col-md-8">
                ...
                <%--Presupuesto--%>
                <div class="form-group">
                    <label for="PresupuestoTextBox" class="col-md-3 control-label input-sm">Password</label>
                    <div class="col-md-8">
